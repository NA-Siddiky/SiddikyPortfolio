export const projects = [
  ...
  },
  {
    ...
    link: "https://hq.programming-hero.com/",
    github: "https://github.com/Programming-Hero1/Hero-HQ-Front-End",
    desc: "Programming Hero HQ is an employee management system to manage employee salary,loan, bonus, tax, advance payment, extra work and many more as evaluating performance and scrum updates.",
  },
  {
    name: "City Riders",
    modalId: "city_riders",
    ...
    desc: "Secure Location based Ride Sharing service on user demand location using map with shielded journey date & authenticate with both users created or google account.",
  },
];
export const blog = [
  {
