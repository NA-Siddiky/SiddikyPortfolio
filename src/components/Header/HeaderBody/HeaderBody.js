...
const HeaderBody = () => {
    return (
        <div className="row d-flex w-100 m-0 p-0 pt-5 styleOfHeader">
            ...
            <div className="col-sm-7 d-flex h-100 justify-content-center align-items-center">
                <HeaderMessage></HeaderMessage>
            </div>
            <div className="col-sm-5 h-100 text-center justify-content-center align-items-end">
